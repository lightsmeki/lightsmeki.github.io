 ...
 * @copyright Copyright (c) 2014, www.hezi.be
 * @since     Version 1.6.1
 *
 * 设置说明  
 * $sitetitle - 标题名称
...
ob_start();
$filefolder = str_replace('\\','/',WEB_ROOT.$ourphp_webpath."templates/");
$sitetitle = 'OurPHP filemanage';
$user = 'admin';
$pass = 'admin';
$safe_num = 0;//设置多少次后禁止登陆，为0则不限制，建议为3-5
$mail = '77701950@qq.com';//若有恶意登录，会发邮件到这个邮箱，前提是mail()函数可用！
