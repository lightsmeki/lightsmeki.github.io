...
/**************************请求参数**************************/
        ...
        //必填，不能修改
        //服务器异步通知页面路径
        $notify_url = 'http://'.$web['weburl'].$ourphp_webpath.'function/api/alipay_webpay/notify_url.php';
        //需http://格式的完整路径，不能加?id=123这类自定义参数
        //页面跳转同步通知页面路径
        $return_url = 'http://'.$web['weburl'].$ourphp_webpath.'function/api/alipay_webpay/return_url.php';
        ...
        //必填，银行简码请参考接口技术文档
        //商品展示地址
        $show_url = 'http://'.$web['weburl'].$ourphp_webpath.'client/user/';
